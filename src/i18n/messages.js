...
export const messages = {
  'zh-CN': {
    ...
    copilot: {
      ...
      chatConnectionError: '无法连接 Content Studio 后端。请在 content-studio-backend 中运行 pnpm dev，或将 VITE_CODEX_SERVER_URL 配置为有效地址。',
      chatEmptyResponse: '未返回可显示内容。',
      threadResetWarning: '原会话上下文无法恢复，已创建新的 Codex 线程继续本次请求。',
      taskRunning: '处理中',
      ...
      outlineTesterBody:
        '输入文章主题并调用本机 Codex 服务 /outline，用于确认 Copilot 前端可以连接本机 AI 服务。',
  ...
  'en-US': {
    ...
    copilot: {
      ...
      chatConnectionError:
        'Cannot reach the Content Studio backend. Run pnpm dev in content-studio-backend, or set VITE_CODEX_SERVER_URL to a valid endpoint.',
      chatEmptyResponse: 'No displayable response returned.',
      threadResetWarning: 'The previous context could not be resumed. A new Codex thread was created for this request.',
      ...
      outlineTesterBody:
        'Enter an article topic and call the local Codex /outline service to verify that Copilot can reach the local AI service.',
