...
export const messages = {
  'zh-CN': {
    ...
    copilot: {
      ...
      chatConnectionError: '无法连接 EdgeOne 后端。请确认后端已公开访问，或将 VITE_API_BASE 配置为有效的 EdgeOne Preview 链接。',
      chatEmptyResponse: '未返回可显示内容。',
      taskRunning: '处理中',
      sources: '引用来源',
      generatedArtifact: '当前会话生成的结构化产物',
      outlineTesterTitle: '线上大纲生成验证',
      outlineTesterBody:
        '输入文章主题并调用 EdgeOne Makers 后端 /outline，用于确认 GitHub Pages 前端可以连接线上 AI 服务。',
  ...
  'en-US': {
    ...
    copilot: {
      ...
      chatConnectionError:
        'Cannot reach the EdgeOne backend. Make sure the backend is publicly accessible, or set VITE_API_BASE to a valid EdgeOne Preview URL.',
      ...
      outlineTesterTitle: 'Online Outline Test',
      outlineTesterBody:
        'Enter an article topic and call the EdgeOne Makers /outline backend to verify that GitHub Pages can reach the live AI service.',
